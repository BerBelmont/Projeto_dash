...
class SnowparkConnection(BaseConnection["Session"]):
    ...
    def query(
        ...
        identical to that of using ``@st.cache_data_data``) as well as simple error handling/retries.
        ...
        # `@st.cache_data_data` behavior. Otherwise, `.query()` being called with different
