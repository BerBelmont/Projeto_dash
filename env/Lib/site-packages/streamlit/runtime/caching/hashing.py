...
"""Hashing for st.cache_data_data and st.cache_data_resource."""
...
"""
    ...
    def _get_error_message_args(
        ...
        if self.cache_type is CacheType.RESOURCE:
            decorator_name = "@st.cache_data_resource"
        elif self.cache_type is CacheType.DATA:
            decorator_name = "@st.cache_data_data"
...
class _HashStack:
    ...
    def __init__(self):
        ...
        # primitive (st.cache_data_data or st.cache_data_resource).
