...
"""Common cache logic shared by st.cache_data_data and st.cache_data_resource."""
            ...
            try:
                ...
                if is_unevaluated_data_object(computed_value):
                    ...
                    raise UnevaluatedDataFrameError(
                        ...
                        "decorated with `st.cache_data_data` but it returns an unevaluated "
                        ...
                        "`st.cache_data_data` can serialize and cache it."
                    ) from ex
